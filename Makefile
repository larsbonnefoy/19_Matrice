...
ex13: $(OBJS_DIR) $(OBJS)
	c++ $(CFLAGS) $(INCLUDES) -c $(SRC_DIR)/ex13.cpp -o $(OBJS_DIR)/ex13.o
	c++ $(CFLAGS) -o $(NAME) $(OBJS) $(OBJS_DIR)/ex13.o
	./matrix
...
.PHONY: all clean fclean re run ex00 ex01 ex02 ex03 ex04 ex05 ex06 ex07 ex08 ex09 ex10 ex11 ex12 ex13 ex14
